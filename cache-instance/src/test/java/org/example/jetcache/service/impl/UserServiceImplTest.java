...
public class UserServiceImplTest {
    ...
    public void getUserById() {
        log.info("获取id为2的User信息：{}", JSON.toJSONString(userService.getUserById(2L)));
    }
    ...
    public void updateUser() {
        User user = new User(2L, "lisi", 1, new Date(), 10);
        log.info("更新id为2的User信息：{}", JSON.toJSONString(user));
